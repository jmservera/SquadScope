...
| FR-035 | Search Console | Connect and verify Google Search Console (and confirm GA4) for the production domain; submit sitemap. | G-002,G-004 | Search visitor | Must | GSC property verified, sitemap submitted; GA4 receiving data. | Production renders secret-backed GA configuration and serves the sitemap; GSC verification, platform receipt, and baseline evidence remain pending. |
