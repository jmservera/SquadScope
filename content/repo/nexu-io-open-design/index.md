---
title: nexu-io/open-design repository trend history
description: 'Evergreen Claracle Observatory page for nexu-io/open-design: 10 weekly appearances, stars, velocity, topics,
  and related repos.'
date: '2026-07-29'
draft: false
layout: repo
...
repo_full_name: nexu-io/open-design
repo_url: https://github.com/nexu-io/open-design
repo_slug: nexu-io-open-design
repo_description: '🎨 The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the
  design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude
  Code / Codex / Cursor / Gemini / OpenCode / Qwen & 20+ CLIs via BYOK.'
...
- name: ai-design
  url: /topics/ai-design/
- name: byok
  url: /topics/byok/
- name: claude-code-for-design
  url: /topics/claude-code-for-design/
- name: claude-design
  url: /topics/claude-design/
- name: coding-agents
  url: /topics/coding-agents/
- name: design-systems
...
nexu-io/open-design has appeared in 10 Claracle weekly issues.
