...
description: 'Evergreen Claracle Observatory page for mermaid-js/mermaid: 12 weekly appearances, stars, velocity, topics,
  and related repos.'
date: '2026-08-03'
draft: false
layout: repo
generated_by: observatory_repo_pages
repo_owner: mermaid-js
repo_name: mermaid
repo_full_name: mermaid-js/mermaid
...
mermaid-js/mermaid has appeared in 12 Claracle weekly issues.
