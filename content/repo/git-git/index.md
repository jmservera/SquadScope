...
repo_slug: git-git
repo_description: Git Source Code Mirror - This is a publish-only repository but pull requests can be turned into patches
...
git/git has appeared in 11 Claracle weekly issues.
