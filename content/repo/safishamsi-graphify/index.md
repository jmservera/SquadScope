...
repo_owner: safishamsi
repo_name: graphify
repo_full_name: safishamsi/graphify
repo_url: https://github.com/safishamsi/graphify
repo_slug: safishamsi-graphify
repo_description: AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder
...
safishamsi/graphify has appeared in 6 Claracle weekly issues.
