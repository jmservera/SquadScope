---
title: abi/screenshot-to-code repository trend history
description: 'Evergreen Claracle Observatory page for abi/screenshot-to-code: 11 weekly appearances, stars, velocity, topics,
  and related repos.'
date: '2026-07-29'
draft: false
layout: repo
...
repo_full_name: abi/screenshot-to-code
repo_url: https://github.com/abi/screenshot-to-code
repo_slug: abi-screenshot-to-code
repo_description: Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
...
abi/screenshot-to-code has appeared in 11 Claracle weekly issues.
