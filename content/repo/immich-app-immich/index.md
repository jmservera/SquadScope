...
description: 'Evergreen Claracle Observatory page for immich-app/immich: 12 weekly appearances, stars, velocity, topics, and
  related repos.'
date: '2026-08-03'
draft: false
layout: repo
...
tag_links:
- name: backup-tool
  url: /tags/backup-tool/
- name: flutter
  url: /tags/flutter/
- name: google-photos
  url: /tags/google-photos/
- name: google-photos-alternative
  url: /tags/google-photos-alternative/
- name: javascript
  url: /tags/javascript/
- name: mobile-app
  url: /tags/mobile-app/
...
- name: nodejs
  url: /tags/nodejs/
- name: photo-gallery
  url: /tags/photo-gallery/
- name: photos
  url: /tags/photos/
- name: photos-management
  url: /tags/photos-management/
- name: self-hosted
...
immich-app/immich has appeared in 12 Claracle weekly issues.
