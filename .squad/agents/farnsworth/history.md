...
- 2026-05-21T12:56:27Z: W21 analysis — Agent skills are consolidating into a distributable artifact category (skills, harnesses, codex skill libraries) faster than press is tracking; vercel-labs/zerolang is the most structurally novel new repo (language-level agent runtime intervention). Star-farming piracy repos (Roblox executors, ROM emulators, Steam unlockers) follow a near-deterministic signature: 400–650 stars, zero forks, keyword-stuffed description, MIT license — flag this cluster as a filter heuristic for future crawls. MCP has crossed the "will it stick?" threshold; the next gap is observability/monitoring for MCP-connected agent workflows. Small model efficiency competition (4B-active claims, HRM architecture, unified multimodal at 3B) is real and accelerating in public repos without press attention. Press-code divergence this week was maximum: 12 TechCrunch articles covered compute deals and capital, not a single GitHub project received genuine editorial coverage.
