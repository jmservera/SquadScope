...
- All three Ralph loops were running; PR #775 was the only open pull request, and its previous reviewed head passed the full CI suite after a timing-only Pagefind rerun.
